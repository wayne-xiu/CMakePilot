 ...
 */
bool MRCPP_API NearZero(const double);
 ...
 */
Eigen::MatrixXd MRCPP_API ad(Eigen::VectorXd);
 ...
 */
Eigen::MatrixXd MRCPP_API Normalize(Eigen::MatrixXd);
 ...
 */
Eigen::Matrix3d MRCPP_API VecToso3(const Eigen::Vector3d&);
 ...
 */
Eigen::Vector3d MRCPP_API so3ToVec(const Eigen::MatrixXd&);
 ...
 */
Eigen::Vector4d MRCPP_API AxisAng3(const Eigen::Vector3d&);
 ...
 */
Eigen::Matrix3d MRCPP_API MatrixExp3(const Eigen::Matrix3d&);
 ...
 */
Eigen::Matrix3d MRCPP_API MatrixLog3(const Eigen::Matrix3d&);
 ...
 *						    [0, 1] ]
 */
Eigen::MatrixXd MRCPP_API RpToTrans(const Eigen::Matrix3d&, const Eigen::Vector3d&);
 ...
 */
std::vector<Eigen::MatrixXd> MRCPP_API TransToRp(const Eigen::MatrixXd&);
 ...
 */
Eigen::MatrixXd MRCPP_API VecTose3(const Eigen::VectorXd&);
 ...
 */
Eigen::VectorXd MRCPP_API se3ToVec(const Eigen::MatrixXd&);
 ...
 */
Eigen::MatrixXd MRCPP_API Adjoint(const Eigen::MatrixXd&);
 ...
 */
Eigen::MatrixXd MRCPP_API MatrixExp6(const Eigen::MatrixXd&);
 ...
 */
Eigen::MatrixXd MRCPP_API MatrixLog6(const Eigen::MatrixXd&);
 ...
 */
Eigen::MatrixXd MRCPP_API FKinSpace(const Eigen::MatrixXd&, const Eigen::MatrixXd&, const Eigen::VectorXd&);
 ...
 * Notes: FK means Forward Kinematics
 */
Eigen::MatrixXd MRCPP_API FKinBody(const Eigen::MatrixXd&, const Eigen::MatrixXd&, const Eigen::VectorXd&);
 ...
 */
Eigen::MatrixXd MRCPP_API JacobianSpace(const Eigen::MatrixXd&, const Eigen::MatrixXd&);
 ...
 */
Eigen::MatrixXd MRCPP_API JacobianBody(const Eigen::MatrixXd&, const Eigen::MatrixXd&);
 ...
 */
Eigen::MatrixXd MRCPP_API TransInv(const Eigen::MatrixXd&);
 ...
 */
Eigen::MatrixXd MRCPP_API RotInv(const Eigen::MatrixXd&);
 ...
 */
Eigen::VectorXd MRCPP_API ScrewToAxis(Eigen::Vector3d q, Eigen::Vector3d s, double h);
 ...
 */
Eigen::VectorXd MRCPP_API AxisAng6(const Eigen::VectorXd&);
 ...
 */
Eigen::MatrixXd MRCPP_API ProjectToSO3(const Eigen::MatrixXd&);
 ...
 */
Eigen::MatrixXd MRCPP_API ProjectToSE3(const Eigen::MatrixXd&);
 ...
 */
double MRCPP_API DistanceToSO3(const Eigen::Matrix3d&);
 ...
 *  return norm(T - I).
 */
double MRCPP_API DistanceToSE3(const Eigen::Matrix4d&);
 ...
 */
bool MRCPP_API TestIfSO3(const Eigen::Matrix3d&);
 ...
 */
bool MRCPP_API TestIfSE3(const Eigen::Matrix4d&);
 ...
 */
bool MRCPP_API IKinBody(const Eigen::MatrixXd&, const Eigen::MatrixXd&, const Eigen::MatrixXd&, Eigen::VectorXd&, double, double);
 ...
 *	thetalist[in][out]: Joint angles that achieve T within the specified tolerances,
 */
bool MRCPP_API IKinSpace(const Eigen::MatrixXd&, const Eigen::MatrixXd&, const Eigen::MatrixXd&, Eigen::VectorXd&, double, double);
 ...
 * 
 */
Eigen::VectorXd MRCPP_API InverseDynamics(const Eigen::VectorXd&, const Eigen::VectorXd&, const Eigen::VectorXd&,
 ...
 * 
 */
Eigen::VectorXd MRCPP_API GravityForces(const Eigen::VectorXd&, const Eigen::VectorXd&,
 ...
 */
Eigen::MatrixXd MRCPP_API MassMatrix(const Eigen::VectorXd&,
                                const std::vector<Eigen::MatrixXd>&, const std::vector<Eigen::MatrixXd>&, const Eigen::MatrixXd&);
 ...
 */
Eigen::VectorXd MRCPP_API VelQuadraticForces(const Eigen::VectorXd&, const Eigen::VectorXd&,
                            const std::vector<Eigen::MatrixXd>&, const std::vector<Eigen::MatrixXd>&, const Eigen::MatrixXd&);
 ...
 */
Eigen::VectorXd MRCPP_API EndEffectorForces(const Eigen::VectorXd&, const Eigen::VectorXd&,
                            const std::vector<Eigen::MatrixXd>&, const std::vector<Eigen::MatrixXd>&, const Eigen::MatrixXd&);
 ...
 * 
 */
Eigen::VectorXd MRCPP_API ForwardDynamics(const Eigen::VectorXd&, const Eigen::VectorXd&, const Eigen::VectorXd&,
                                   const Eigen::VectorXd&, const Eigen::VectorXd&, const std::vector<Eigen::MatrixXd>&, 
                                   const std::vector<Eigen::MatrixXd>&, const Eigen::MatrixXd&);
 ...
 */
void MRCPP_API EulerStep(Eigen::VectorXd&, Eigen::VectorXd&, const Eigen::VectorXd&, double);
 ...
 */
Eigen::MatrixXd MRCPP_API InverseDynamicsTrajectory(const Eigen::MatrixXd&, const Eigen::MatrixXd&, const Eigen::MatrixXd&,
 ...
 */
std::vector<Eigen::MatrixXd> MRCPP_API ForwardDynamicsTrajectory(const Eigen::VectorXd&, const Eigen::VectorXd&, const Eigen::MatrixXd&,
	const Eigen::VectorXd&, const Eigen::MatrixXd&, const std::vector<Eigen::MatrixXd>&, const std::vector<Eigen::MatrixXd>&,
 ...
 */
Eigen::VectorXd MRCPP_API ComputedTorque(const Eigen::VectorXd&, const Eigen::VectorXd&, const Eigen::VectorXd&,
 ...
 */
double MRCPP_API CubicTimeScaling(double, double);
 ...
 */
double MRCPP_API QuinticTimeScaling(double, double);
 ...
 */
Eigen::MatrixXd MRCPP_API JointTrajectory(const Eigen::VectorXd&, const Eigen::VectorXd&, double, int, int);
 ...
 *        and the Nth is Xend
 */
std::vector<Eigen::MatrixXd> MRCPP_API ScrewTrajectory(const Eigen::MatrixXd&, const Eigen::MatrixXd&, double, int, int);
 ...
 *  motion.
 */
std::vector<Eigen::MatrixXd> MRCPP_API CartesianTrajectory(const Eigen::MatrixXd&, const Eigen::MatrixXd&, double, int, int);
 ...
 */
std::vector<Eigen::MatrixXd> MRCPP_API SimulateControl(const Eigen::VectorXd&, const Eigen::VectorXd&, const Eigen::VectorXd&,
